            ...
            <div class="tab-content d-flex flex-grow-1" id="nav-tabContent">
                <div class="tab-pane fade flex-grow-1 show active" id="nav-home" role="tabpanel"
                    ...
                    <div class="col card laneSetup d-none">
                        <h5 class="card-header">노트 레인 설정</h5>
                        <div class="card-body">
                    ...
                    <div class="col card giveUP">
                        <h5 class="card-header" id="giveUPTitle">기브업(Give UP)</h5>
                        <div class="card-body">
                            <div class="mb-3 form-check form-switch">
                    ...
                    <div class="col card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check p-0">
                                <div class="mb-3 form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="playSfx">
                ...
                <div class="tab-pane fade flex-grow-1" id="nav-noteLane" role="tabpanel"
                    ...
                    <div class="col card">
                        <h5 class="card-header" id="flTitle">노트 판정</h5>
                        <div class="card-body">
                            <div class="form-check">
                                <div class="mb-3 form-check form-switch">
