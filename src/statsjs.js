...
Stats.Panel = function (name, fg, bg) {
	...
	const ucs = (() => {
		...
		return { w, h, tsize, lft, autoTextPos: conf.autoTpos ?? false };
	})();
	var WIDTH = ucs.w * PR, HEIGHT = ucs.h * PR,
		TEXT_X = 3 * PR,
		//TEXT_Y = 2 * PR,
		TEXT_harp = (ucs.tsize / 2),
		TEXT_Y = TEXT_harp * PR,
		GRAPH_X = 3 * PR,
		//GRAPH_Y = 15 * PR,
		GRAPH_Y = (ucs.tsize + 8) * PR, //6
		//GRAPH_WIDTH = 74 * PR,
		GRAPH_WIDTH = (ucs.w - 6) * PR,
		//GRAPH_HEIGHT = 30 * PR;
		GRAPH_HEIGHT = (ucs.h - 16) * PR - 10; //18
